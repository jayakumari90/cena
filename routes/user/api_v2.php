...
use App\Http\Controllers\Api\V2\User\UserRestroController;
use App\Http\Controllers\Api\V2\User\DatingController;
...
Route::group(['namespace' => 'Api/V2/User', 'middleware' => ['jwt.verify']], function () {
