...
use App\Http\Controllers\Api\V2\Restaurant\RestaurantController;
use App\Http\Controllers\Api\V2\Restaurant\DishController;
use App\Http\Controllers\Api\V2\Restaurant\OrderController;
...
Route::group(['namespace' => 'Api/V2/Restaurant'], function () {
...
Route::group(['namespace' => 'Api/V2/Restaurant', 'middleware' => ['jwt.verify']], function () {
